...
Dreamsis::Application.routes.draw do
  ...
  match 'participant_signup/basics' => 'participant_signup#basics', :as => :participant_signup_basics
  match 'participant/dashboard' => 'welcome#participant', :as => :participant_home
