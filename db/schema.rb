...
ActiveRecord::Schema.define(:version => 20141004212416) do
  ...
  create_table "people", :force => true do |t|
    ...
    t.string   "occupation"
    t.integer  "annual_income",                         :limit => 10
  ...
  create_table "scholarships", :force => true do |t|
    ...
    t.text     "description"
    t.integer  "default_amount",          :limit => 10
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "customer_id"
  ...
  create_table "test_scores", :force => true do |t|
    ...
    t.datetime "taken_at"
    t.integer  "total_score",    :limit => 10
  ...
  create_table "test_types", :force => true do |t|
    t.string   "name"
    t.integer  "maximum_total_score",      :limit => 10
    t.text     "sections"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "customer_id"
